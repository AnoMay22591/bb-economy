...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        <img src="../assets/img/logo-bb.jpg" class="navbar-brand-img h-100" alt="...">
        <span class="ms-3 font-weight-bold">BB Economy-2</span>
    </a>
  </div>
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('report') ? 'active' : '') }}" href="{{ url('report') }}">
          ...
          <span class="nav-link-text ms-1">ออกรายงาน</span>
        </a>
      </li>
      {{-- <li class="nav-item">
        <a class="nav-link {{ (Request::is('insert') ? 'active' : '') }}" href="{{ url('insert') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>document</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">BB Insert</span>
        </a>
      </li> --}}
